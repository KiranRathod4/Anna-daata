...
export const recentReviews: Review[] = [
    { id: 'rev1', vendorName: 'Mumbai Chaat House', rating: 5, comment: 'Always fresh and on time!', avatarUrl: 'https://picsum.photos/seed/woman/40/40', aiHint: 'smiling woman' },
    { id: 'rev2', vendorName: 'Delhi Dosa Point', rating: 4, comment: 'Good quality, sometimes a bit late.', avatarUrl: 'https://picsum.photos/seed/man/40/40', aiHint: 'man portrait' },
    { id: 'rev3', vendorName: 'Kolkata Rolls', rating: 5, comment: 'The best onions and potatoes in the city!', avatarUrl: 'https://picsum.photos/seed/face/40/40', aiHint: 'woman face' },
];
